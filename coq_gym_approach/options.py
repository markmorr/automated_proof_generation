# -*- coding: utf-8 -*-
"""
Created on Wed Mar 30 18:17:36 2022
...
def parse_args():
    ...
    parser.add_argument( ##*** CHANGED
        "--no_validation", action="store_true", default=True, help="no validation is performed"
    )
    ...
    opts.log_dir = './runs/astactic/' #*** CHANGE
    opts.checkpoint_dir = './runs/astactic/checkpoints/'
